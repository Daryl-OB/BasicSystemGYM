...
<?php
$ruta = "../..";
$titulo = "App GYM - Consultar Cliente";
                    ...
                    <div class="card col-md-6">
                        <div class="card-body">
                            <form id="frm_consultar_cli" name="frm_consultar_cli" method="post">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label for="txt_codcli" class="frm-label">Código</label>
                                        <input type="text" class="form-control" id="txt_codcli" name="txt_codcli" placeholder="Código a buscar" maxlength="5" autofocus />
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row align-items-start">
                                            ...
                                            <div class="col-md-6">
                                                <h5 class="card-title">Identificacion (DNI)</h5>
                                                <p class="ident card-text">&nbsp;</p>
                                            </div>
                                            <div class="col-md-6">
                                                <h5 class="card-title">Telefono</h5>
                                                <p class="telef card-text">&nbsp;</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="text-center mt-3">
                                <a type="submit" href="consultar_cliente.php" class="btn btn-outline-primary">
