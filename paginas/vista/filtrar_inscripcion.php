...
<?php
$ruta = "../..";
$titulo = "App GYM - Filtrar Inscripciones";
...
<body>
    ...
    <div class="container mt-3">
        <header>
            <h1><i class="fas fa-search"></i> Filtrar Inscripciones</h1>
        </header>
        ...
        <section>
            <article>
                <div class="row justify-content-center mt-3">
                    <div class="col-md-5">
                        <form id="form_filtrar_inscr" name="form_filtrar_inscr" method="post">
                            <div class="input-group mb-3">
                                ...
                                <a class="btn btn-primary" href="filtrar_inscripcion.php">Nuevo</a>
                            </div>
                        </form>
                    </div>
                </div>
