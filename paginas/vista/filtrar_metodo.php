...
<?php
$ruta = "../..";
$titulo = "App GYM - Filtrar Metodos de Pago";
...
<body>
    ...
    <div class="container mt-3">
        <header>
            <h1><i class="fas fa-search"></i> Filtrar Metodos de Pago</h1>
        </header>
        ...
        <section>
            <article>
                <div class="row justify-content-center mt-3">
                    <div class="col-md-5">
                        <form id="form_filtrar_met" name="form_filtrar_met" method="post">
                            <div class="input-group mb-3">
                                ...
                                <a class="btn btn-primary" href="filtrar_metodo.php">Nuevo</a>
                            </div>
                        </form>
                    </div>
                </div>
