...
<?php
$ruta = "../..";
$titulo = "App GYM - Filtrar Promociones";
...
<body>
    ...
    <div class="container mt-3">
        <header>
            <h1><i class="fas fa-search"></i> Filtrar Promociones</h1>
        </header>
        ...
        <section>
            <article>
                <div class="row justify-content-center mt-3">
                    <div class="col-md-5">
                        <form id="form_filtrar_prom" name="form_filtrar_prom" method="post">
                            <div class="input-group mb-3">
                                ...
                                <a class="btn btn-primary" href="filtrar_promocion.php">Nuevo</a>
                            </div>
                        </form>
                    </div>
                </div>
