...
<?php
$ruta = "../..";
$titulo = "App GYM - Consultar Servicio";
...
<body>
    ...
    <div class="container mt-3">
        <header>
            <h1><i class="fas fa-search"></i> Consultar Servicio</h1>
        </header>
            ...
            <article>
                <div class="row justify-content-center mt-3">
                    <div class="card col-md-6">
                        <div class="card-body">
                            <form id="frm_consultar_serv" name="frm_consultar_serv" method="post">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label for="txt_codserv" class="frm-label">Código</label>
                                        <input type="text" class="form-control" id="txt_codserv" name="txt_codserv" placeholder="Código a buscar" maxlength="5" autofocus />
                                    </div>
                            ...
                            <div class="text-center mt-3">
                                <a type="submit" href="consultar_servicio.php" class="btn btn-outline-primary">
